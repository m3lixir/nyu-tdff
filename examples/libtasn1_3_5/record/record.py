...
#    logging.basicConfig(stream=sys.stdout, level=logging.DEBUG)
    ...
    ############################################################################
    firmware = abspath('examples/libtasn1_3_5/firmware/BUILD/firmware.bin')
    openocd_config = abspath('examples/libtasn1_3_5/record/nucleo-f207zg.cfg')
    ...
    ############################################################################
    avatar.add_transition(0x80006f0, nucleo, panda, synced_ranges=[ram],
                          stop=True)
    ############################################################################
