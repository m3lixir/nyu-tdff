...
#    logging.basicConfig(stream=sys.stdout, level=logging.DEBUG)
    ...
    ############################################################################
    firmware = abspath('examples/nucleo_l152re/firmware/BUILD/firmware.bin')
    openocd_config = abspath('examples/nucleo_l152re/record/nucleo-l152re.cfg')
    ...
    ############################################################################
    avatar.add_transition(0x8000280, nucleo, panda, synced_ranges=[ram],
                          stop=True)
    ############################################################################
